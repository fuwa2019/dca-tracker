...
| Copy any competitor visual language or brand wording | superseded 2026-08-20 | `docs/decisions/2026-08-20-wealthfolio-ui-alignment.md` | The owner directed the frontend to follow Wealthfolio's interface language as closely as practical. Interaction, composition and visual scales are now aligned deliberately and reimplemented in this repository; Wealthfolio's AGPL code and assets, its name and its logo remain off limits, and Flexoki is taken from its own MIT upstream with attribution |
