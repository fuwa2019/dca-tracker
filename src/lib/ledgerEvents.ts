...
const CHIPS: Record<LedgerEventKind, LedgerEventChip> = {
  ...
  broker_withdrawal: { kind: 'broker_withdrawal', label: '出金', tone: 'bad', direction: 'loss', group: 'cash' },
  ...
  // Net FX conversion gain or cost inside a broker account, one row per day.
  fx_conversion: { kind: 'fx_conversion', label: '换汇损益', tone: 'neutral', direction: 'neutral', group: 'cash' },
};
